...
- Clone this repo
- Edit the [configmap.yaml](../../blob/master/newrelic-logging/templates/values.yaml) (add link) to define the EC2 tags you want to capture as well as the log configurations such as log source, patterns, etc ... that you want to use
